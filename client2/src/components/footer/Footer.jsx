...
export default function Footer() {
  return (
    ...
    <footer className="w-full bg-amber-600 rounded-3xl p-8 md:pt-12 text-white">
      {/* === Row 1: Heading + Socials === */}
      <div className="w-full grid md:grid-cols-2 gap-10">
        {/* Left Text Block */}
        <div>
          <h2 className="text-4xl md:text-6xl font-bold text-white">Let’s Talk</h2>
        ...
        <div className="hidden md:block">
          ...
          <div className="relative w-full max-w-md">
            <input
              ...
              className="w-full h-14 rounded-full px-6 pr-16 bg-white text-gray-500 outline-none shadow"
            />
      ...
      {/* === Copyright === */}
      <div className="text-center md:text-end mt-5 text-gray-200 text-sm">© Copyright Reserved by ADKAMP.com</div>
    </footer>
    </div>
  );
}
