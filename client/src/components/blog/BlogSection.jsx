  ...
  return (
    <section className="mt-15 mb-15 w-full bg-black text-white py-16 px-4 md:px-10">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
        {/* Left heading */}
        <div>
          <p className="text-sm text-lime-400 font-medium flex items-center gap-2 uppercase tracking-wide">
            ✦ From the Blog
          </p>
          ...
          <h2 className="mt-3 text-4xl md:text-5xl font-bold leading-tight">
            ...
            <br />
            update <span className="text-lime-400">& articles</span>
          </h2>
        </div>
      ...
      <div className="max-w-7xl mx-auto mt-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        {posts.map((post) => (
          <div
            key={post.id}
            className="bg-[#111] rounded-xl overflow-hidden shadow-lg hover:-translate-y-1 hover:shadow-2xl transition duration-300"
          >
            {/* Image */}
            ...
            {/* Content */}
            <div className="p-5">
              <div className="text-xs text-gray-400 flex gap-2 mb-2">
              ...
              <button className="text-sm text-lime-400 flex items-center gap-1 hover:underline">
                Read More <span>↗</span>
              </button>
            </div>
          </div>
