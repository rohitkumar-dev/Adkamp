...
function Header() {
  ...
  return (
    <div className="flex items-center sticky top-0 z-50"> 
     <nav className="px-5 md:px-8 h-18 md:h-20 w-full flex flex-wrap justify-between  items-center bg-gray-100 backdrop-blur-sm  ">
      ...
      <div className={` ${open? "": "hidden"} text-center bg-white border border-gray-200 md:border-0 text-black backdrop-blur-sm md:backdrop-blur-none md:bg-transparent mt-1 md:mt-0 md:inline-block w-full order-last md:order-0 md:w-1/2 font-normal md:font-medium text-md md:text-[16] lg:text-lg rounded-lg p-4 md:p-5`}>
        <ul className=" md:flex flex-row justify-evenly ">
          <li className="pb-2 md:pb-0"><Link to="/">Home</Link></li>
          <li className="pb-2 md:pb-0"><Link to="/portfolio">Portfolio</Link></li>
          <li className="pb-2 md:pb-0"><Link to="/services">Services</Link></li> 
          <li className="pb-2 md:pb-0"><Link to="/events">Events</Link></li>
